...
export default function Home() {
  ...
  return (<>
      <header id="Home" className="relative  h-screen">
        ...
        <h1 className="text-9xl tracking-wide h-[80vh] flex flex-col justify-end  py-10 px-4 text-transparent bg-clip-text bg-gradient-to-b from-30% via-50% to-90% from-primary/60 dark:from-primary-100 via-primary dark:via-secondary-100 dark:to-primary-100 to-primary/60">
      ...
      <section id="About" className="h-screen py-10 px-6 flex ">
        <main className="w-[60%] flex flex-col items-start  gap-20 z-10">
          <h2 className="text-7xl mb-4 shadow-[0_0_15px_5px] shadow-secondary dark:shadow-primary-100 text-primary-100 dark:text-secondary-100 rounded-2xl px-12 py-3 skew-x-6 dark:first-line:text-primary-100 first-line:text-secondary bg-transparent hover:bg-primary-100/5 dark:hover:bg-primary-100/30 hover:shadow-primary/30 dark:hover:shadow-secondary/30 transition-all duration-500 ">What <br/>I Do Best</h2>
        ...
        <div className="w-[30%] h-[50vh] self-end rounded-2xl overflow-hidden z-0 opacity-60 dark:opacity-40 bg-cover relative origin-bottom-right scale-125 hover:scale-150 hover:opacity-50 transition-all duration-300 delay-100">
          <Image
            src={'/images/tech.jpg'}
            alt="photo"
            fill
      ...
      <h2 className="text-7xl mb-4 shadow-[0_0_15px_5px] shadow-secondary dark:shadow-primary-100 text-primary-100 dark:text-secondary-100 rounded-2xl px-12 py-3 skew-x-6 inline-block dark:first-line:text-primary-100 first-line:text-secondary bg-transparent hover:bg-primary-100/5 dark:hover:bg-primary-100/30 hover:shadow-primary/30 dark:hover:shadow-secondary/30 transition-all duration-500 ">Techs <br/>Behind My Crafts</h2>
      </section>
        <Techs/>
        <Projects/>
      <div className="w-[100%] h-[2px] my-16 bg-gradient-to-r from-transparent via-secondary to-transparent via-50% from-20% to-80%"/>
       ...
       <p className="text-2xl text-primary dark:text-secondary-100 tracking-widest font-IBMBold w-[60%] my-20">Whether you&apos;re looking for a developer to bring your concept to life or want to team up on a groundbreaking project, I&apos;m here for collaboration and innovation. Let&apos;s work together and make something exceptional !</p>
