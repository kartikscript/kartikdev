...
import { ArrowRight, ArrowRightFromLine, ExternalLink } from "lucide-react";
  ...
  return (<>
      ...
      <section id="About" className="h-screen py-10 px-6 flex ">
        <main className="w-[60%] flex flex-col items-start  gap-20 z-10">
          <h2 className="text-7xl mb-4 shadow-[0_0_15px_5px] shadow-primary-100 text-secondary-100 rounded-2xl px-12 py-3 skew-x-6 first-line:text-primary-100 bg-transparent hover:bg-primary-100/30 hover:shadow-secondary/30 transition-all duration-500 ">What <br/>I Do Best</h2>
          ...
          <a href="#Projects" className="relative mt-6 group animate-pulse text-secondary-100 text-2xl  px-4 py-1 rounded-2xl border-x-2 border-main transition-all duration-200 delay-100 
      ...
      <h2 className="text-7xl mb-4 shadow-[0_0_15px_5px] shadow-primary-100 text-secondary-100 rounded-2xl px-12 py-3 skew-x-6 first-line:text-primary-100 bg-transparent hover:bg-primary-100/30 hover:shadow-secondary/30 transition-all duration-500 inline-block">Techs <br/>Behind My Crafts</h2>
      </section>
        <Techs/>
        <Projects/>
      <div className="w-[100%] h-[2px] my-16 bg-gradient-to-r from-transparent via-secondary to-transparent via-50% from-20% to-80%"/>
       ...
       <main id='Contact' className="min-h-screen  py-10 px-6">
         <h2 className="text-6xl mb-4 shadow-[0_0_15px_5px] shadow-primary-100 text-secondary-100 rounded-2xl px-12 py-3 skew-x-6 first-line:text-primary-100 bg-transparent hover:bg-primary-100/30 hover:shadow-secondary/30 transition-all duration-500 inline-block">Let&apos;s <br/>Collaborate & Innovate</h2>
          <p className="text-2xl  tracking-widest font-IBMBold w-[60%] my-20">Whether you're looking for a developer to bring your concept to life or want to team up on a groundbreaking project, I&apos;m here for collaboration and innovation. Let&apos;s work together and make something exceptional !</p>
          <a target="_blank" href="https://mail.google.com/mail/?view=cm&fs=1&to=suk.m4hh@gmail.com&su=Hiring%20and%20Collaboration%20Discussions&body=Dear%20Kartik%2C%0D%0A%0D%0AI%20hope%20this%20message%20finds%20you%20well.%20My%20name%20is%20%5BSender's%20Name%5D%2C%20and%20I%20am%20with%20%5BCompany%20Name%5D%2C%20a%20%5Bbrief%20description%20of%20the%20company%2C%20e.g.%20leading%20tech%20firm%20specializing%20in%20innovative%20software%20solutions%5D.%20We%20are%20currently%20looking%20to%20expand%20our%20team%20and%20are%20interested%20in%20exploring%20potential%20collaboration%20opportunities%20with%20talented%20individuals%20like%20yourself.%0D%0A%0D%0AWe%20admire%20your%20work%20in%20%5Bspecific%20field%20or%20project%5D%2C%20and%20we%20believe%20that%20your%20skills%20could%20be%20a%20great%20fit%20for%20our%20projects.%20We%20would%20love%20to%20hear%20more%20about%20your%20career%20aspirations%20and%20the%20type%20of%20role%20you%20envision%20for%20yourself.%0D%0A%0D%0ACould%20you%20please%20share%20your%20thoughts%20on%20the%20desired%20role%20you%20are%20looking%20for%3F%0D%0A%0D%0AWe%20are%20excited%20about%20the%20possibility%20of%20collaborating%20with%20you%20and%20look%20forward%20to%20discussing%20this%20further.%0D%0A%0D%0AThank%20you%2C%0D%0A%5BSender's%20Name%5D%0D%0A%5BJob%20Title%5D%0D%0A%5BCompany%20Name%5D%0D%0A%5BContact%20Information%5D"
                      ...
                      className='relative group font-IBMBold bg-primary-100 text-secondary-100 text-4xl py-1 px-6 transition-all duration-300 z-0 hover:bg-transparent hover:text-secondary-100
                                ...
                                '
                      >Contact Me
            <ArrowRight className="absolute size-10 right-0 top-1/2 -translate-y-1/2 scale-0  transition-all duration-300 text-secondary-100 origin-left group-hover:scale-125 group-hover:-right-5"/>
            </a>     
       </main>
       <footer className="h-[50vh] w-full bg-primary-100 flex flex-col justify-center ">
        <div className="flex justify-around items-center">
          <h1 className="text-5xl text-main font-DancingScript font-[600]">Kartik <span className="text-secondary">Script</span></h1>
          <div >
