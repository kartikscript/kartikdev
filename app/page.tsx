  ...
  return (<>
      ...
      <section id="About" className="relative  min-h-screen py-20 px-6 bg-primary-100/30 dark:bg-black ">
        ...
        <div className="mb-20 relative rounded-3xl bg-black/40 border border-white/10 overflow-hidden">
          <div className="animate-pulse z-10 absolute left-0 top-0 h-full w-24 bg-gradient-to-r from-primary-800 to-transparent "/>
          <div className="animate-pulse z-10 absolute right-0 top-0 h-full w-24 bg-gradient-to-l from-primary-800 to-transparent "/>
          <TextHor/>
        </div>
        <Blob left="50%" top="50%"/>
      ...
      <section  className=" relative z-0 py-20  bg-primary-800/5">
      ...
      <div className="w-[100%] h-[2px] bg-black bg-gradient-to-r from-transparent via-white to-transparent "/>
       ...
       <section id='Contact' className="min-h-screen bg-black py-10 px-6">
          <Title title="Let's Connect"/>
          <div className="flex flex-col items-center gap-8">
             <h1 className="text-5xl font-Oxanium tracking-wide font-[500]">Got a project in mind? Let&apos;s talk!</h1>
       ...
       <footer className="h-[50vh] w-full bg-primary-800/20 text-white px-4 flex flex-col justify-center ">
        <div className="flex justify-around items-start">
          <h1 className="text-5xl font-Oxanium text-main  self-center first-letter:text-6xl first-letter:text-purple-600">Kartik <span className="text-secondary">Script</span></h1>
          <div >
