...
const Projects = () => {
  ...
  return (
              ...
              <main id='Projects' className='h-screen overflow-hidden flex gap-20 items-center justify-center '>
                  <div className=' relative flex flex-col justify-center items-center w-[50%] h-full cursor-pointer  *:transition-all *:duration-700 
                                  before:z-20 before:absolute before:w-full before:h-[10%] before:inset-0 before:bg-gradient-to-t before:from-transparent before:to-secondary-100 dark:before:to-primary before:from-10% 
                                  after:z-20 after:absolute after:w-full after:h-[10%] after:bottom-0 after:bg-gradient-to-b after:from-transparent after:to-secondary-100 dark:after:to-primary after:from-10% 
                                  '
                  >
                    {
