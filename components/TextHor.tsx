...
const TextHor = () => {
  ...
  return (
    <div className='*:inline-flex relative z-0 lg:text-4xl md:text-3xl sm:text-2xl text-xs py-2 sm:py-4 lg:*:py-6 font-Oxanium  whitespace-nowrap overflow-hidden'>
